...
export const HeadingAnimatedSvg: FC<HeadingAnimatedSvg> = ({animated, text}) => {
  ...
  return (
    ...
    >
      <svg
        ...
        width={active ? 30 : 50}
        height={active ? 30 : 50}
        className={mergeClassNames("origin-center transition-all duration-700 ease-in", active && "animate-bounce")}
      >
        <path
          id="dp_path001"
